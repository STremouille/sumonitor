 ...
 *
 */
public class ExportTargetFrame extends JFrame{
	...
	private ExportTargetWorker worker;
	 ...
	 */
	public ExportTargetFrame(ArrayList<Date> date,ArrayList<Integer> progress,ArrayList<Integer> nbreSSRFSU,ArrayList<Integer> punchlistOpened,TreeMap<Date, Integer> docProgress2) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ExportTargetFrame.class.getResource("/img/icone.png")));
	...
	class ExportListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			worker = new ExportTargetWorker(date,progress,nbreSSRFSU,punchlistOpened,docProgress,path);
